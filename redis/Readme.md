...
NAME: redis
LAST DEPLOYED: Mon Nov  6 15:58:11 2023
NAMESPACE: redis
STATUS: deployed
REVISION: 2
TEST SUITE: None
...
1. Run a Redis&reg; pod that you can use as a client:
   ...
   kubectl run --namespace redis redis-client --restart='Never'  --env REDIS_PASSWORD=$REDIS_PASSWORD  --image docker.io/bitnami/redis:7.2.2-debian-11-r0 --command -- sleep infinity
